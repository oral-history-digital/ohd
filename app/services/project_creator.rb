class ProjectCreator < ApplicationService
  ...
  def create_default_landing_page_texts
    landing_page_texts = {
      ...
      ru: 'The interview with INTERVIEWEE is part of the online archive "ARCHIVE_TITLE". To access the full interviews with transcripts and additional material, you must log in or register at the "Oral-History.Digital" platform and request activation to the "ARCHIVE_TITLE" archive. Please observe the terms of use must, in particular the personal rights of the interviewees.',
      es: 'The interview with INTERVIEWEE is part of the online archive "ARCHIVE_TITLE". To access the full interviews with transcripts and additional material, you must log in or register at the "Oral-History.Digital" platform and request activation to the "ARCHIVE_TITLE" archive. Please observe the terms of use must, in particular the personal rights of the interviewees.',
      el: 'The interview with INTERVIEWEE is part of the online archive "ARCHIVE_TITLE". To access the full interviews with transcripts and additional material, you must log in or register at the "Oral-History.Digital" platform and request activation to the "ARCHIVE_TITLE" archive. Please observe the terms of use must, in particular the personal rights of the interviewees.',
      uk: 'The interview with INTERVIEWEE is part of the online archive "ARCHIVE_TITLE". To access the full interviews with transcripts and additional material, you must log in or register at the "Oral-History.Digital" platform and request activation to the "ARCHIVE_TITLE" archive. Please observe the terms of use must, in particular the personal rights of the interviewees.',
      ar: 'The interview with INTERVIEWEE is part of the online archive "ARCHIVE_TITLE". To access the full interviews with transcripts and additional material, you must log in or register at the "Oral-History.Digital" platform and request activation to the "ARCHIVE_TITLE" archive. Please observe the terms of use must, in particular the personal rights of the interviewees.'
    }
