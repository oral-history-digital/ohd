...
export default class VideoPlayer extends React.Component {
    ...
    resolutionSelector(){
        if (this.props.interview.media_type && this.props.mediaStreams) {
            ...
            if (resolutions.length > 1) {
                ...
                return (
                    <select value={this.props.resolution} onBlur={this.handleResolutionChange} className={'resolutionselector'}>
                        {options}
                    </select>
                )
            }
    ...
    render() {
        const { locale, interviewee, flyoutTabsVisible, transcriptScrollEnabled } = this.props;
                ...
                <div className={classNames('VideoPlayer', {
                    ...
                    <header className={classNames('VideoHeader', {
                        ...
                        <div className="VideoHeader-controls">
                            <select value={this.props.tape} onBlur={this.handleTapeChange} className={this.props.interview.tape_count == 1 ? 'hidden tapeselector' : 'tapeselector'}>
                                {this.tapeSelector()}
                            </select>
