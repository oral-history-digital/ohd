...
export default class Segment extends React.Component {
    ...
    transcript() {
        ...
        return this.props.data.text[`${this.props.contentLocale}-original`] || ''
    }
    ...
    speakerIcon() {
        if (this.speakerChanged()) {
            ...
            return (
                <div className="content-trans-speaker-link" title={this.props.data.speaker_id ? fullname(this.props, this.props.people[this.props.data.speaker_id]) : this.props.data.speaker}
