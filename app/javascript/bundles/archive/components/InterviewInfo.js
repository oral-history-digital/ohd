...
export default class InterviewInfo extends React.Component {
    ...
    render() {
        let cameraName = `${this.props.cinematographer.names[this.props.locale].firstname} ${this.props.cinematographer.names[this.props.locale].lastname}`
        let interviewerName = `${this.props.interviewer.names[this.props.locale].firstname} ${this.props.interviewer.names[this.props.locale].lastname}`
        ...
        return(
            <div>
                ...
                <p><span className="flyout-content-label">{ArchiveUtils.translate(this.props, 'interview')}:</span><span className="flyout-content-data">{interviewerName}</span></p>
                <p><span className="flyout-content-label">{ArchiveUtils.translate(this.props, 'camera')}:</span><span className="flyout-content-data">{cameraName}</span></p>
