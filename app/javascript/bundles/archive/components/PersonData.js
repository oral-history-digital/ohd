...
export default class PersonData extends React.Component {
    ...
    render() {
        return(
            <div>
                <p><span className="flyout-content-label">{ArchiveUtils.translate(this.props, 'interviewee_name')}</span><span className="flyout-content-data">{this.props.name}</span></p>
