...
ActiveRecord::Schema.define(version: 2021_02_03_151703) do
  ...
  create_table "registry_name_translations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["registry_name_id", "locale"], name: "index_registry_name_translations_on_registry_name_id_and_locale"
  ...
  create_table "task_type_permissions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "task_type_translations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "user_accounts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    ...
    t.index ["confirmation_token"], name: "index_user_accounts_on_confirmation_token"
