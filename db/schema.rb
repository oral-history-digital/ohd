...
ActiveRecord::Schema[8.0].define(version: 2026_06_29_141253) do
  ...
  create_table "homepage_block_translations", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "homepage_blocks", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "instance_settings", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "institution_projects", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.index ["project_id", "institution_id"], name: "index_institution_projects_on_project_id_and_institution_id"
  end
  ...
  create_table "interview_languages", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["interview_id", "spec", "language_id"], name: "index_interview_languages_on_interview_spec_language"
  end
  ...
  create_table "interviews", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["project_id", "created_at"], name: "index_interviews_on_project_id_and_created_at"
  ...
  create_table "registry_references", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["ref_object_type", "registry_entry_id", "interview_id"], name: "index_registry_references_on_type_entry_interview"
  ...
  create_table "webauthn_credentials", charset: "utf8", collation: "utf8_general_ci", force: :cascade do |t|
