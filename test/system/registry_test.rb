...
class RegistryTest < ApplicationSystemTestCase
  ...
  test 'create registry entry from norm-data-api' do
    ...
    sleep 1
    click_on 'Istanbul, city in Turkey located at the Bosporus Strait'
    sleep 1
    ...
    assert all('#registry_entry_latitude')[0].value == '41.013611' 
    assert all('#registry_entry_longitude')[0].value == '28.949444' 
