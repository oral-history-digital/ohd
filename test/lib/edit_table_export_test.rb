...
class EditTableExportTest < ActiveSupport::TestCase
  ...
  test 'should write a csv containing all relevant data' do
    ...
    assert_equal "Вступление", @first_row_entries[5]
    assert_equal "", @first_row_entries[6]
    assert_equal "Einleitung", @first_row_entries[7]
    ...
    assert_equal "жизнь", @second_row_entries[6]
    assert_equal "", @second_row_entries[7]
