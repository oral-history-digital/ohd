...
// WEBPACK_SERVE is set by webpack-dev-server (webpack 5 / shakapacker).
// It is NOT set during a static build (bin/shakapacker), so this
// correctly gates HMR-only plugins to dev-server runs only.
const isDevServer = isDevelopment && !!process.env.WEBPACK_SERVE;
