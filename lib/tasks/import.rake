namespace :import do
  ...
  namespace :setup do
    ...
    task :all => :environment do
      ...
      %w(
        annotation category collection contribution contributor import interview
        location_reference location_segment photo segment tagging tag tape text_material
        usage_report user_account_ip user_content
  ...
  namespace :interviews do
    ...
    task :limited, [:number] => :environment do |task, args|
      ...
      repo_dir = CeDiS.config.archive_management_dir
