...
- fix: show existing project logos in display settings ([#154](https://github.com/oral-history-digital/ohd/pull/154))
...
- fix: access config project loading ([#128](https://github.com/oral-history-digital/ohd/pull/128))
