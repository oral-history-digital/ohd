...
load 'lib/archive-authentication.rb'
...
# Recreate the authentication_test DB
require 'active_record/migration'
db_config = YAML::load_file(File.join(RAILS_ROOT, 'config/database.yml'))['authentication_test']
...
puts "Setup authentication test DB."
