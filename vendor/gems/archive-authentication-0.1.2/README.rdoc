...
== 6. Create the authentication DB and install missing migrations
...
== 7. Add necessary routes to your application
...
== 9. Add gem dependency on archive-authentication
And finally add the archive-authentication gem in environment.rb:
