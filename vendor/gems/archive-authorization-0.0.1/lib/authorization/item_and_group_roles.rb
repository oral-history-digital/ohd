...
module Authorization
  module ItemAndGroupRoles
    ...
    # 2) per item
    #
    # Also, the Mixin expects item ownership to be
    # determined by a owned_by?(:user) method on item.
    ...
    module UserExtensions
      ...
      module ClassMethods
        def acts_as_authorized_user(roles_relationship_opts = {})
          include Authorization::ItemAndGroupRoles::UserExtensions::InstanceMethods
    ...
    module ModelExtensions
      ...
      module ClassMethods
        def acts_as_authorizable
          ...
          include Authorization::ItemAndGroupRoles::ModelExtensions::InstanceMethods
